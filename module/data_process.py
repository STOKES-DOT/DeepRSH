    ...
    for index, row in tqdm(df.iterrows(), total=df.shape[0], desc="Processing H2 Curve"):
        ...
        try:
            ...
            molecules_neutral.append(molecule_from_pyscf(
                mf_n, name=f"{name}_neutral", energy=target_energy_neutral, omegas=omegas
            ))
...
output_h5_path = "h2_dataset.h5"
neutral, cation, anion = process_h2_energy_from_csv(
...
manual_save_path = "h2_dataset_manual.h5"
